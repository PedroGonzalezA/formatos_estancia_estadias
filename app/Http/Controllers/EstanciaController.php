...
//actualizar documento f03
    ...
    public function verObservaciones_f03(){
        ...
        ->join('cedula_registro','cedula_registro.id_c_r','=','documentos.id_c_registro')
        ->select('cedula_registro.id_c_r','cedula_registro.nombre_c_r','cedula_registro.estado_c_r','cedula_registro.observaciones_c_r','documentos.id_d','respuesta_doc.id_documentos','users.name')
        ->where('users.id',$userID)
        ->get();
