...
class definicion_proyectoController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect('estancia1')->with('success','F04 AGREGADO');
    }
    //subir f04 estancia2
    public function store2(Request $request) {
            ...
            return redirect('estancia2')->with('success','F04 AGREGADO');
     }
    //subir f04 estadia
    public function store_estadia(Request $request) {
        $request->validate([
            'grupo' => 'required|max:45',
            'id_proceso' => 'required',
            'puesto' => 'required|max:200',
        ...
        return redirect('estadia')->with('success','F04 AGREGADO');
    }
}
