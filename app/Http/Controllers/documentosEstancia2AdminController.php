...
class documentosEstancia2AdminController extends Controller
{
    ...
    public function aceptar_estancia2_carga_horaria_admin($idU,$id,$name) {
        ...
        return redirect('estancia2_Documentos')->with('aceptado',$resp);
    }
    ...
    public function  guardarObservaciones_estancia_carga_horaria_admin(Request $request,$id,$idU){
        ...
        return redirect('estancia2_Documentos')->with('observaciones',$resp);
    }
    ...
    public function aceptar_estancia2_f02_admin($idU,$id,$name) {
        ...
        $resp='Carta de aceptación Aceptada y '.CorreoController::store($idU, "Carta de aceptación",1);
         return redirect('estancia2_Documentos')->with('success',$resp);
    }
    ...
    public function buscador_estancia(Request $request){        
        ...
        return view('nombres.buscar_estancia2',['nombres'=>$nombres,'texto'=>$texto,'estatus'=>$estatus,'año'=>$año,'documentos'=>$users0,'documentos1'=>$datos,'documentos2'=>$datos1,'documentos3'=>$datos2,'documentos4'=>$datos3,'documentos5'=>$datos4,'alumnos'=>$alumnos]);
    }
