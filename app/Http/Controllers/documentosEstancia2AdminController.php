...
class documentosEstancia2AdminController extends Controller
{
    public function ver(){
        //datos usuarios
        ...
        return view('admin.documentosEstancia2',['documentos'=>$datos,'documentos1'=>$datos1,'documentos2'=>$datos2,'documentos3'=>$datos3,'documentos4'=>$datos4]);
    }
    ...
    public function ver_cd_estancia_carga_horaria_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' Carga horaria no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_carga_horaria_admin($idU,$id,$name) {
        ...
        $carta->estado_c_h=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('pendiente','Carga horaria Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_carga_horaria_admin(Request $request,$id){
        ...
        $carta->save();
        return redirect('estancia2_Documentos')->with('observaciones','Carga horaria Con Observacion');
    }
    ...
    public function ver_cd_estancia_constancia_derecho_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' Constancia derecho no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_constancia_derecho_admin($idU,$id,$name) {
        ...
        $carta->estado_c_d=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('pendiente','Constancia derecho Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_constancia_derecho_admin(Request $request,$id){
        ...
        $carta->save();
        return redirect('estancia2_Documentos')->with('observaciones','Constancia derecho Con Observacion');
    }
    ...
    public function ver_cd_estancia_carta_responsiva_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' Carta responsiva no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_carta_responsiva_admin($idU,$id,$name) {
        ...
        $carta->estado_c_r=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('pendiente','Carta responsiva Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_carta_responsiva_admin(Request $request,$id){
        ...
        $carta->save();
        return redirect('estancia2_Documentos')->with('observaciones','Carta responsiva Con Observacion');
    }
     ...
     public function ver_cd_estancia_f01_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' F-01 Carta Presentación no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_f01_admin($idU,$id,$name) {
        ...
        $carta->estado_c_p=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('pendiente','F-01 Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_f01_admin(Request $request,$id){
        ...
        $carta->save();
        return redirect('estancia2_Documentos')->with('observaciones','F-01 Con Observacion');
    }
    ...
    public function ver_cd_estancia_f02_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' F-02 Carta de Aceptación no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_f02_admin($idU,$id,$name) {
        ...
        $carta->estado=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('success','F-02 Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_f02_admin(Request $request,$id){
        ...
        $carta->save();
        return redirect('estancia2_Documentos')->with('success','F-02 Con Observacion');
    }
    //f03
    public function ver_cd_estancia_f03_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' F-03 Cédula Registro no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_f03_admin($idU,$id,$name) {
        ...
        $carta->estado_c_r=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('success','F-03 Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_f03_admin(Request $request,$id){
        ...
        $carta->observaciones_c_r=$observacion;
        $carta->save();
        return redirect('estancia2_Documentos')->with('success','F-03 Con Observacion');
    }
    //f04
    public function ver_cd_estancia_f04_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' F-04 Definición de proyecto no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_f04_admin($idU,$id,$name) {
        ...
        $carta->estado_d_p=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('success','F-04 Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_f04_admin(Request $request,$id){
        ...
        $carta->save();
        return redirect('estancia2_Documentos')->with('success','F-04 Con Observacion');
    }
    ...
    public function ver_cd_estancia_f05_admin($name) {
        ...
        {
            return redirect('estancia2_Documentos')->with('sinRespuesta',' F-05 Carta de Liberación no ha sido encontrado');
        }
    }
    ...
    public function pendiente_estancia2_f05_admin($idU,$id,$name) {
        ...
        $carta->estado_c_l=1;
        $carta->save();
         return redirect('estancia2_Documentos')->with('success','F-05 Pendiente');
    }
    ...
    public function  guardarObservaciones_estancia_f05_admin(Request $request,$id){
        ...
        $carta->save();
        return redirect('estancia2_Documentos')->with('success','F-05 Con Observacion');
    }
    ...
    public function buscador_estancia(Request $request){        
        ...
        return view('nombres.buscar_estancia2',['nombres'=>$nombres,'texto'=>$texto,'documentos'=>$users0,'documentos1'=>$datos,'documentos2'=>$datos1,'documentos3'=>$datos2,'documentos4'=>$datos3,'documentos5'=>$datos4,'alumnos'=>$alumnos]);
    }
    ...
    public function buscador_estancia_c(Request $request){        
        ...
        return view('nombres.buscar_estancia2_c',['nombres'=>$nombres,'texto'=>$texto,'documentos'=>$users0,'documentos1'=>$datos,'documentos2'=>$datos1,'documentos3'=>$datos2,'documentos4'=>$datos3,'documentos5'=>$datos4]);
    }
}
