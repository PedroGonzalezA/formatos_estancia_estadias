	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container p-3">
			<div class="page-header">
			  <h2 class="text-titles">Documentos Registrados<small>(Estadía)</small></h2>
			</div>
		</div>
         <!---notificacion --->
                                ...
                                @if ($respuestaCR->name==$respuestaD->name)
                                    <div class="saber-f03 col-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 doc f03" >
                                        ...
                                        <div class="row text-center"> 
                                            ...
                                            @endswitch
                                            <div class="col-6 p-1">
                                                <form class="" method="post" action="{{ route('ver_cd_estadia_f03_admin.index',[$respuestaCR->id_usuario,$respuestaCR->id_c_registro, $respuestaCR->nombre_c_r]) }}">
                                                    @csrf
                                                    <button type="submit" class="btn  btnVer" > <i class="zmdi zmdi-eye zmdi-hc-lg"></i> Ver</button>
                                                </form>	
                                            </div>
