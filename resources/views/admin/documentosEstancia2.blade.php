	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container p-3">
			<div class="page-header">
			  <h2 class="text-titles">Documentos Registrados<small>(Estancia II)</small></h2>
			</div>
		</div>
         <!---notificacion --->
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 doc" >
                                            ...
                                            <div class="row text-center">
                                                ...
                                                @switch($respuestaH->estado_c_h)
                                                    ...
                                                    <!--con observaciones-->
                                                        <div class="col-6 p-1">
                                                            <form method="post" action="{{ route('aceptar_estancia2_carga_horaria_admin.index',[$respuestaH->id_usuario,$respuestaH->id_c_horaria, $respuestaH->nombre_c_h]) }}">
                                                                @csrf
                                                                <button type="submit" class="btn btn-success btnAceptar" > <i class="zmdi zmdi-check zmdi-hc-lg"></i> Aceptar</button>
                                                            </form>	
                                                        </div>
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('pendiente_estancia2_carga_horaria_admin.index',[$respuestaH->id_usuario,$respuestaH->id_c_horaria, $respuestaH->nombre_c_h]) }}">
                                                                @csrf
                                                                <button type="submit" class="btn btn-warning btnPendiente" >Pendiente</button>
                                                            </form>	
                                                        </div>
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('conObservaciones_estancia_carga_horaria_admin2.index') }}">
                                                                @csrf
                                                    ...
                                                    @case(1)
                                                        ...
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('observaciones_estancia2_carga_horaria_admin.index',[$respuestaH->id_usuario]) }}">
                                                                @csrf
                                                                <input type="text" name="id_c" id="id_c" value="{{$respuestaH->id_c_horaria}}" class="id_d">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 doc" >
                                            ...
                                            <div class="row text-center">
                                                ...
                                                @switch($respuestaCD->estado_c_d)
                                                    ...
                                                    <!--con observaciones-->
                                                        <div class="col-6 p-1">
                                                            <form method="post" action="{{ route('aceptar_estancia2_constancia_derecho_admin.index',[$respuestaCD->id_usuario,$respuestaCD->id_c_derecho, $respuestaCD->nombre_c_d]) }}">
                                                                @csrf
                                                                <button type="submit" class="btn btn-success btnAceptar" > <i class="zmdi zmdi-check zmdi-hc-lg"></i> Aceptar</button>
                                                            </form>	
                                                        </div>
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('pendiente_estancia2_constancia_derecho_admin.index',[$respuestaCD->id_usuario,$respuestaCD->id_c_derecho, $respuestaCD->nombre_c_d]) }}">
                                                                @csrf
                                                                <button type="submit" class="btn btn-warning btnPendiente" >Pendiente</button>
                                                            </form>	
                                                        </div>
                                                    ...
                                                    @case(1)
                                                        ...
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('observaciones_estancia2_constancia_derecho_admin.index',[$respuestaCD->id_usuario]) }}">
                                                                @csrf
                                                                <input type="text" name="id_c" id="id_c" value="{{$respuestaCD->id_c_derecho}}" class="id_d">
                                                                <button type="submit" class="btn btn-danger btnObservaciones" > <i class="zmdi zmdi-alert-circle zmdi-hc-lg"></i> Observaciones</button>
                                                            </form>	
                                            ...
                                            <div class="row text-center">
                                                ...
                                                @switch($respuestaCR->estado_c_r)
                                                    ...
                                                    @case(1)
                                                        ...
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('observaciones_estancia2_carta_responsiva_admin.index',[$respuestaCR->id_usuario]) }}">
                                                                @csrf
                                                                <input type="text" name="id_c" id="id_c" value="{{$respuestaCR->id_c_responsiva}}" class="id_d">
                                                                <button type="submit" class="btn btn-danger btnObservaciones" > <i class="zmdi zmdi-alert-circle zmdi-hc-lg"></i> Observaciones</button>
                                                            </form>	
                                            ...
                                            <div class="row text-center">
                                                ...
                                                @switch($respuestaCP->estado_c_p)
                                                    ...
                                                    @case(1)
                                                        ...
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('observaciones_estancia2_f01_admin.index',[$respuestaCP->id_usuario]) }}">
                                                                @csrf
                                                                <input type="text" name="id_c" id="id_c" value="{{$respuestaCP->id_c_presentacion}}" class="id_d">
                                                                <button type="submit" class="btn btn-danger btnObservaciones" > <i class="zmdi zmdi-alert-circle zmdi-hc-lg"></i> Observaciones</button>
                                                            </form>	
                                            ...
                                            <div class="row text-center">
                                                ...
                                                @switch($respuestaC->estado)
                                                    ...
                                                    @case(1)
                                                        ...
                                                        <div class="col-12 p-1">
                                                            <form method="post" action="{{ route('observaciones_estancia2_f02_admin.index',[$respuestaC->id_usuario]) }}">
                                                                @csrf
                                                                <input type="text" name="id_c" id="id_c" value="{{$respuestaC->id_c_aceptacion}}" class="id_d">
                                        ...
                                        <div class="row text-center"> 
                                            ...
                                            @switch($respuestaCR->estado_c_r)
                                                ...
                                                @case(1)
                                                    ...
                                                    <div class="col-12 p-1">
                                                        <form method="post" action="{{ route('observaciones_estancia2_f03_admin.index',[$respuestaCR->id_usuario]) }}">
                                                            @csrf
                                                            <input type="text" name="id_c" id="id_c" value="{{$respuestaCR->id_c_registro}}" class="id_d">
                                                            <button type="submit" class="btn btn-danger btnObservaciones" > <i class="zmdi zmdi-alert-circle zmdi-hc-lg"></i> Obsevaciones</button>
                                                        </form>	
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <!--pendiente-->
                                                            @case(1)
                                                                ...
                                                                <div class="col-12 p-1">
                                                                    <form method="post" action="{{ route('observaciones_estancia2_f04_admin.index',[$respuestaDP->id_usuario]) }}">
                                                                        @csrf
                                                                        <input type="text" name="id_c" id="id_c" value="{{$respuestaDP->id_d_proyecto}}" class="id_d">
                                                                        <button type="submit" class="btn btn-danger btnObservaciones" > <i class="zmdi zmdi-alert-circle zmdi-hc-lg"></i> Obsevaciones</button>
                                                                    </form>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <!--pendiente-->
                                                            @case(1)
                                                                ...
                                                                <div class="col-12 p-1">
                                                                    <form method="post" action="{{ route('observaciones_estancia2_f05_admin.index',[$respuestaCL->id_usuario]) }}">
                                                                        @csrf
                                                                        <input type="text" name="id_c" id="id_c" value="{{$respuestaCL->id_c_liberacion}}" class="id_d">
                                                                        <button type="submit" class="btn btn-danger btnObservaciones" > <i class="zmdi zmdi-alert-circle zmdi-hc-lg"></i> Obsevaciones</button>
                                                                    </form>	
