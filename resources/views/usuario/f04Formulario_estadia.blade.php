        ...
        <!-- Wrap the content of your PDF inside a main tag -->
            <div class="container">
                ...
                @forelse ($datos['cedula'] as $dato)               
                    <form  method="POST" action="{{ route('f04Guardar_estadia.index') }}">
                        @csrf
                        <!--titulo-->
                                    ...
                                    <tbody>
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input type="number" name="tiempo_1" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input type="number" name="tiempo_2" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number"  name="tiempo_3" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number"  name="tiempo_4" class="horas" min="0" max="600"> 
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input type="number"  name="tiempo_5" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input type="number"  name="tiempo_6" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input type="number" name="tiempo_7" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input type="number"  name="tiempo_8" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input type="number"  name="tiempo_9" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number"  name="tiempo_10" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number"  name="tiempo_11" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                        ...
                                        <tr class=""> 
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number"  name="tiempo_12" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number"  name="tiempo_13" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td  class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number" name="tiempo_14" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                                            ...
                                            <td class="p-0 px-1 tabla" style="width: 50px; border: 1px solid black; height:40px;">
                                                <div>
                                                    <div class=" text-center p-1">
                                                        <input  type="number"  name="tiempo_15" class="horas" min="0" max="600">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-0 px-1 tabla" style="border: 1px solid black; height:40px;">
                            ...
                            <table class="table table-borderless p-0 m-1 tabla_r" >
                                <tbody>
                                    ...
                                    <tr class="p-0 m-0">
                                        <td colspan="2" class="p-1 text-center sello" style="height: 70px; border-bottom: 1px solid black;">SELLO</td>
                                        <td colspan="1" ></td>
                                        <td colspan="2" class="p-1" style="height: 70px;"><div><div style="border-bottom: 1px solid black;"></div><div class="subT text-center"><small>Llene la cédula de registro</small></div></div></td>
                                    </tr>
                                </tbody>
                            </table>
                            <button class="btn btn-dark btn-lg btn-block" type="submit"><i > Guardar</i></button>
